...
export default function Footer() {
  return (
    <div className="wrapper mx-auto px-5 bg-background">
      ...
      <div className="md:py-5">
        <div className="flex flex-col items-center justify-between mt-6 md:mt-0 md:flex-row">
          <div className="logo flex items-center">
            <p className="text-sm text-gray-200 mx-1">
              Built with ❤️ and ☕️ by Caio Fernando
            </p>
          </div>

          <div>
            <div className="wrapper flex flex-wrap text-base text-center m-3 bg-background text-gray-200">
              <Link
                aria-label="Github"
